...
BV=5.1
LOADED_MODULE_FILES="color.so print ln cut basename uname unlink tee sleep seq rm rmdir realpath print printenv mktemp mkdir id head dirname base64 libtimehistory_bash.so"
